...
app.post("/students", async (req, res) => {
  try {
    ...
    const response = await axios.post(
      "https://project4th-production-639f.up.railway.app/encode",
      { image: base64 },
      { timeout: 20000 }
    );
...
app.post("/recognize", async (req, res) => {
  try {
    ...
    const response = await axios.post(
      "https://project4th-production-639f.up.railway.app/recognize",
      { image: base64 },
      { timeout: 20000 }
    );
  ...
  // 🔥 NEW (2 PM onwards)
  { id: 6, start: 14 * 60, end: 14 * 60 + 50 },   // 2:00–2:50
  { id: 7, start: 14 * 60 + 50, end: 14 * 60 + 100 }, // 2:50–3:40
  { id: 8, start: 14 * 60 + 100, end: 14 * 60 + 150 }, // 3:40–4:30
  { id: 9, start: 14 * 60 + 150, end: 14 * 60 + 200 }  // 4:30–5:20
];
